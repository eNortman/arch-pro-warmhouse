package warmhouse.devcontrol.config;
...
class MqConfiguration {
    ...
    public JmsListenerContainerFactory<?> jmsTopicContainerFactory(ActiveMQConnectionFactory connectionFactory) {
        ...
        factory.setPubSubDomain(true); // Crucial for topics
        return factory;
    }
    ...
    public MessageConverter jacksonJmsMessageConverter() {
        ...
        converter.setTypeIdPropertyName("_doctype"); // Добавляет информацию о типе объекта в заголовок сообщения
        return converter;
    }
